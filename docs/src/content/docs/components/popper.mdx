---
title: Flexipop - Popper for Flexilla
description: djkfjdf
---
...
- **`placement`**: Defines the position of the popper relative to the reference element (`top`, `bottom`, `left`, `right`, with alignment options like `-start`, `-end`).
...
- **`preventOverflow`**: Ensure that the popper stays within the viewport boundaries.
